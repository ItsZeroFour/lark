...
const COLS = [
  { h: 'Платформа', l: [['Проекты', '/#platform'], ['Команды', '/#teams'], ['Proof of Work', '/#platform'], ['Ларкинс', '/']] },
  { h: 'Компания',  l: [['О нас', '/about'], ['Команда', '/team'], ['Журнал', '#'], ['Пресса', '#']] },
  { h: 'Материалы', l: [['Документация', '#'], ['Гайды', '#'], ['Сообщество', '#'], ['Поддержка', '#']] },
  { h: 'Правовое',  l: [['Условия', '#'], ['Политика', '#'], ['Безопасность', '#'], ['Куки', '#']] },
];
